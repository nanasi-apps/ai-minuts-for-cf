/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 44a65a5eac65c58ca6e4ea57e7805264)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		NUXT_R2_ACCESS_KEY_ID: string;
		NUXT_R2_SECRET_ACCESS_KEY: string;
		NUXT_R2_BUCKET_NAME: string;
		minuts_videos: R2Bucket;
		ai_minuts: D1Database;
		QUEUE_SERVICE: Fetcher /* ai-minuts-queue */;
		AI: Ai;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GOOGLE_REDIRECT_URI" | "JWT_SECRET" | "NUXT_R2_ACCOUNT_ID" | "NUXT_R2_ACCESS_KEY_ID" | "NUXT_R2_SECRET_ACCESS_KEY" | "NUXT_R2_BUCKET_NAME">> {}
}
