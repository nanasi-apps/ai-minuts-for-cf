/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ab7f089cbd75d1c64c8c09d670497ef6)
// Runtime types generated with workerd@1.20251125.0 2025-11-28 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "QueueDO";
	}
	interface Env {
		STREAM_TRANSFORM_DOMAIN: "ai-minuts.nanasi-apps.xyz";
		QUEUE_DO: DurableObjectNamespace<import("./src/index").QueueDO>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STREAM_TRANSFORM_DOMAIN">> {}
}
